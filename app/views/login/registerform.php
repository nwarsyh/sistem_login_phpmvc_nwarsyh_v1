                ...
                <div class="row justify-content-center mt-5">
                    <div class="col-lg-5 mt-5">
                        <div class="card shadow-lg border-0 rounded-lg mt-5 mb-5">
                            <div class="card-header"><h3 class="text-center font-weight-light my-1">Form Registrasi</h3></div>
                            <div class="card-body">
                                <form action="<?= BASEURL; ?>/Login/doRegister" method="post" enctype="multipart/form-data">
                                    <div class="col-auto mb-3 mt-3">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="fa-solid fa-address-book"></i></div>
                                            <input type="text" class="form-control form-control-sm" id="namadepan" name="namadepan" placeholder="Nama Depan" required>
                                        </div>
                                    </div>
                                    <div class="col-auto mb-3 mt-3">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="fa-solid fa-address-book"></i></div>
                                            <input type="text" class="form-control form-control-sm" id="namabelakang" name="namabelakang" placeholder="Nama Belakang" required>
                                        </div>
                                    </div>
                                    <div class="col-auto mb-3 mt-3">
                                        <div class="input-group">
                                    ...
                                    <div class="d-flex align-items-center justify-content-end mt-4 mb-0">
                                        ...
                                        <button type="submit" class="btn btn-sm btn-primary"><i class="fa-solid fa-floppy-disk"></i> Daftar</button>
                                    </div>
                                </form>
                            </div>
                        </div>
